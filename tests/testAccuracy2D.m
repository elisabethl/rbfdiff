...
%
Psi = RBF_QR_diffmat_2D(0,xc,ep,C,R);
[~,PsiO] = RBF_QR_diffmat_2D_old('0',xc,ep,R,C);
%
% Compute the differentiation matrices
%
[B,Te] = RBF_QR_diffmat_2D(0,Psi,xe);
[Bx,Te] = RBF_QR_diffmat_2D(1,Psi,Te);
[BL,Te] = RBF_QR_diffmat_2D(1.5,Psi,Te);
%
BO = RBF_QR_diffmat_2D_old('0',xe,PsiO);
BxO = RBF_QR_diffmat_2D_old('x',xe,PsiO);
ByO = RBF_QR_diffmat_2D_old('y',xe,PsiO);
BLO = RBF_QR_diffmat_2D_old('L',xe,PsiO);
%

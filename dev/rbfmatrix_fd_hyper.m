...
% ddrbf = @(ep,rd2) ep^2*(32*ep^2-56*ep^2*rd2-64*ep^4*rd2+48*ep^4*rd2.^2+8+...
%     14*ep^2*rd2.^2-8*rd2.^3*ep^4-4*rd2+16*ep^6*rd2.^2-8*ep^6*rd2.^3+...
%     ep^6*rd2.^4).*exp(-ep^2*rd2); %L2

...
if display
    ...
    elseif dim == 2
        theta = linspace(0,2*pi,1000); theta = [theta, 2*pi];
    ...
    ylim([-1.5 1.3]);
    if strcmp(mode,"unfitted")
        l = legend('Domain, $\Omega$','Node points','Eval points','Interpreter','latex','location','south','Orientation','Horizontal');
        % l.NumColumns = 1;
        l.FontSize = 20; 
    else
        l = legend('Domain, $\Omega$','Node points','Interpreter','latex','location','south','Orientation','Horizontal');
        l.FontSize = 20; 
    end
